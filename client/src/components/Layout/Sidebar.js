...
const Sidebar = ({ isOpen, onClose, user, isAdmin, currentPath, onLogout }) => {
  const { virtualBalance } = useSelector((state) => state?.auth || {});
  // useLocation is used by react-router-dom for navigation context
  useLocation();
        ...
        <div className="px-4 py-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-gray-500">{formatCurrency(virtualBalance || 0)}</p>
            </div>
          </div>
        </div>
